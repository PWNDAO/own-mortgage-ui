<template>
    <div v-if="isConnected && userDeposit > 0n" class="border p-4">
        <h3 class="font-heading text-xl mb-4">Your contribution (${{ userDepositFormatted }} {{ CREDIT_NAME }})</h3>
        <hr class="mb-4"/>
        <div>
            <div>Your ${{ userDepositFormatted }} {{ CREDIT_NAME }} deposit earns interest in AAVE until accepted.</div>
